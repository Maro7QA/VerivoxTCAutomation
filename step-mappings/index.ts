...
export const givenStepMappings = {
  ...
  'I navigate to verivox home page': step.iNavigateToTheTestcafeSamplePage,
};
...
export const whenStepMappings = {
  ...
  'user selects postal code and submits': step.postalCodeSubmit,
  'user selects first tariff': step.firstTariff,
  'user selects sign-up button': step.signupButton,
  'user selects switch tariff': step.switchTariff
};
...
export const thenStepMappings = {
  ...
  'user selects power section': step.powerSelection,
  'user fills in personal data': step.fillInPersonalData,
  'user lands on confirmation page': step.confirmationPage
};
