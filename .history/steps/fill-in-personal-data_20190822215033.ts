...
export default async (_: string) => {
  ...
  await t
    ...
    .wait(500)
    .click(selector.birthday)
    .wait(500)
    .typeText(selector.birthday, birthday, { paste: true })
    .wait(500)
    .click(selector.debitCard)
    .wait(500)
    .typeText(selector.bankIBAN, iban, { paste: true })
    .wait(500)
    .click(selector.checkboxBankData)
    .wait(500)
    .click(selector.submitButtonDataDescription)
    .wait(15000)
};
