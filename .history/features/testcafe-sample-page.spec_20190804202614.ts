...
import { and, given, then } from '../step-runner';

/**
 * @feature
 */
fixture('Feature: TestCafe Example')
  .before(async (ctx: { config: import("../../../../../Users/maronadi/Documents/testcafe-starter-master-verivox/config/config.interface").IConfig; }) => {
